...
if(isset($_POST['submit'])){
    ...
    $sql = "insert into tb_subjects(course_id,sub_name,semester,total_marks,created_by) values('$course','$sub_name','$semester','$total_marks','$email')";
	...
	<div class="content-body ">
        ...
        <div class="card profile-card card-bx m-b30">
            <div class="card-header">
                <h6 class="title">Subjects setup</h6>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="col-sm-6 m-b30">
                        ...
                        <div class="col-sm-6 m-b30">
                            ...
                            <input type="text" class="form-control" name="semester" placeholder="Semester No.">
                        </div>
                        <div class="col-sm-6 m-b30">
