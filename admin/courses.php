...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Course Management || Gravity</title>
    <!-- FAVICONS ICON -->
        ...
        ***********************************-->
        <div class="content-body ">
            ...
            <div class="row">
                ...
                <a href="add-course.php" class="mx-5 my-3"><button class="btn btn-primary">Add Course</button></a>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr class="px-3">
                                                    ...
                                                    <td><a href="update-course.php?id=<?php echo $row['cid'];?>" class="px-3"><i class="fa-solid fa-pen-to-square"></i></a>
                                                        <a href="delete-course.php?id=<?php echo $row['cid'];?>" class="px-3"><i class="fa-sharp fa-solid fa-trash"></i></a></td>
                                                </tr>
                                        <?php
                                                $count++;
                                            }
