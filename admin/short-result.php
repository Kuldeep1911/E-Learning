                            ...
                            <div class="table-responsive active-projects style-1">
                                ...
                                <table id="empoloyees-tblwrapper" class="table">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT *
                                        FROM tb_last_single_result join tb_students on tb_last_single_result.sid = tb_students.sid 
                                        ";
                                        $count=1;
                                        ...
                                        ?>
                                                <tr class="px-3">
                                                    ...
                                                    <td>
                                                    <a href="view-short-result.php?&roll_no=<?php echo $row['sid'] ?>&course=<?php echo $row['cid']; ?>" class="px-3"><i class="fa-solid fa-eye"></i></a>
                                                        <a href="update-short-result.php?roll_no=<?php echo $row['sid'] ?>&course=<?php echo $row['cid']; ?>" class="px-3"><i class="fa-solid fa-pen-to-square"></i></a>
                                                        <a href="delete-short-result.php?roll_no=<?php echo $row['sid'] ?>&course=<?php echo $row['cid'];?>" class="px-3"><i class="fa-sharp fa-solid fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                        <?php
                                                $count++;
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <form method="get" action="add-single-result.php">
                            <div class="row">
