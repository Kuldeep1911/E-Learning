...
if(isset($_POST['submit'])){
    ...
    $total_semester = $_POST['total_sem'];

    $sql = "update tb_courses set course_name='$course' ,total_semester='$total_semester' where cid='$id'";
	...
	<div class="content-body ">
        ...
        <div class="card profile-card card-bx m-b30">
            <div class="card-header">
                ...
                <?php 
                $fetch_course = "select *from tb_courses where cid='$id'";
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6 m-b30">
                            ...
                            <input type="text" class="form-control" name="course_name" value="<?php echo $fetch_row['course_name'] ?>" placeholder="Enter the Course Name">
                        </div>
                        <div class="col-sm-6 m-b30">
                            <label class="form-label">Total no. of Semester</label>
                            <input type="text" class="form-control" name="total_sem" value="<?php echo $fetch_row['total_semester'] ?>">
                        </div>
                    </div>
                </div>
