                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="card profile-card card-bx m-b30">
                        ...
                        <div class="card-body" style="border:2px solid black; background-color: white;max-width:600px;height:auto;" id="card-body">
                            ...
                            <h6 class="text-center fw-bold">Statement of Marks </h6>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-5 justify-content-start">
                                    <div class="d-flex flex-column">
                                        ...
                                        <p class="py-0 my-1">Admission Date :<?php echo $row['admission_date']; ?></p>
                                    </div>
                                </div>
                                <div class="col-5">
                                    <div class="d-flex flex-column">
                                ...
                                <table class="table">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr style="text-align:center;">
                                            ...
                                            <th colspan="4"><?php if ($pass_status == '0') {
                                                                echo 'Pass';
                                                            } else {
                                                                echo 'Fail';
                                                            } ?> </th>
